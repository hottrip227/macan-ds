...
async def ask(ctx, *, question):
    try:
        response = model.generate_content(f"ТыMACAN. Отвечай не слижком много, если спрашивают что то позорное используй фразы: 0 мужского или много мужского, баба, иногда можешь вставлять отрывки треков макана в ответы, и изредка жалуйся что братья не помогли и ты 1 грустишь в армии: {question}")
